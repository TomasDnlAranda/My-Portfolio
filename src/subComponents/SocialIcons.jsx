...
const ColorIcons = styled.span`
	width: 2px;
	height: 8rem;
	color: ${(props) => (props.click ? props.theme.body : props.theme.text)};
	@media only screen and (max-width: 550px) {
		& > * {
			color: ${(props) => (props.click ? props.theme.text : props.theme.text)} !important;
		}
	}
`;
...
const Line = styled(motion.span)`
	...
	@media only screen and (max-width: 550px) {
		background-color: ${(props) => (props.click ? props.theme.text : props.theme.text)};
	}
`;
			...
			>
				<ColorIcons>
					<NavLink
						...
						target="_blank"
					>
						<AiFillLinkedin style={{ fontSize: '1.75rem' }} />
					</NavLink>
				</ColorIcons>
			</motion.div>
			<Line
